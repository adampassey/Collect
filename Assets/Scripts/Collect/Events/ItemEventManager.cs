...
namespace Collect.Events {
    ...
    public class ItemEventManager {
        ...
        /**
         *  <summary>Trigger any (valid or invalid) item drop.
         *  </summary>
         *  <param name="item">The `GameObject` being dropped</param>
         *  <param name="data">The `PointerEventData`</param>
         **/
        ...
        /**
         *  <summary>Trigger any (valid or invalid) item pick up.
         *  </summary>
