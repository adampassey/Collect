...
namespace Collect.Slots {
    ...
    public class SlotWithType : Slot {
        ...
        /**
         *  <summary>When this slot gets an item dropped on it,
         *  it verifies that it is of the same ItemType.
         *  If so, it adds the item to the slot. If not,
         *  it uses the eventData as the drop was successful.</summary>
         *
        ...
        /**
         *  <summary>Attempts to add an item to this slot.
         *  If the item does not have a `DraggableItemType` or
         *  does not match the type specified by this slot,
         *  will throw a `CannotAddItemException`</summary>
         *
         *  <param name="item">The `Draggable` being added</param>
         **/
